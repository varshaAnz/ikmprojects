...
public class BirthConfiguration {
    ...
    @Value("${egov.pdf.niabirthcert.createEndPoint}")
    private String	egovPdfBirthNiaEndPoint;
    ...
    //Whatsapp
    @Value("${kafka.topics.notification.whatsapp}")
    private String whatsappNotifTopic;
